...
struct MapData_
{
  ...
  _graph_type graph;
  using _nodes_type =
    std::vector<slam_msgs::msg::KeyFrame_<ContainerAllocator>, typename ContainerAllocator::template rebind<slam_msgs::msg::KeyFrame_<ContainerAllocator>>::other>;
  _nodes_type nodes;
  ...
  Type & set__nodes(
    const std::vector<slam_msgs::msg::KeyFrame_<ContainerAllocator>, typename ContainerAllocator::template rebind<slam_msgs::msg::KeyFrame_<ContainerAllocator>>::other> & _arg)
  {
    this->nodes = _arg;
    return *this;
  }
