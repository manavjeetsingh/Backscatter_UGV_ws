...
#ifndef BACKSCATTER_MOVEMENT_RECORD_MSGS_SRVS__SRV__DETAIL__ODOM_RECORD__FUNCTIONS_H_
#define BACKSCATTER_MOVEMENT_RECORD_MSGS_SRVS__SRV__DETAIL__ODOM_RECORD__FUNCTIONS_H_
...
/// Initialize srv/OdomRecord message.
/**
...
/// Finalize srv/OdomRecord message.
/**
...
/// Create srv/OdomRecord message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Request__init().
...
/// Destroy srv/OdomRecord message.
/**
 * It calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Request__fini()
...
/// Check for srv/OdomRecord message equality.
/**
...
/// Initialize array of srv/OdomRecord messages.
/**
...
/// Finalize array of srv/OdomRecord messages.
/**
 * It calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Request__fini()
...
/// Create array of srv/OdomRecord messages.
/**
 * It allocates the memory for the array and calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/OdomRecord messages.
/**
 * It calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/OdomRecord message array equality.
/**
...
/// Copy an array of srv/OdomRecord messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_backscatter_movement_record_msgs_srvs
...
/**
 * It calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_backscatter_movement_record_msgs_srvs
...
/**
 * It allocates the memory for the array and calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_backscatter_movement_record_msgs_srvs
...
/**
 * It calls
 * backscatter_movement_record_msgs_srvs__srv__OdomRecord_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BACKSCATTER_MOVEMENT_RECORD_MSGS_SRVS__SRV__DETAIL__ODOM_RECORD__FUNCTIONS_H_
