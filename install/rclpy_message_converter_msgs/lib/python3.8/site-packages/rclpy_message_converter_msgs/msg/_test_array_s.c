...
bool rclpy_message_converter_msgs__msg__test_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rclpy_message_converter_msgs.msg._test_array.TestArray", full_classname_dest, 54) == 0);
  }
  rclpy_message_converter_msgs__msg__TestArray * ros_message = _ros_message;
  {  // data
...
PyObject * rclpy_message_converter_msgs__msg__test_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rclpy_message_converter_msgs.msg._test_array");
