...
static size_t _GetGlobalPointCloud_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_slam_msgs__srv__GetGlobalPointCloud_Request(
    full_bounded, 0);
}
...
static size_t _GetGlobalPointCloud_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_slam_msgs__srv__GetGlobalPointCloud_Response(
    full_bounded, 0);
}
