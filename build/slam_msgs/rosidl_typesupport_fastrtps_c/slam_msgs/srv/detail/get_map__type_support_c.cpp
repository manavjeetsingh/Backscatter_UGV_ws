  ...
  void * untyped_ros_message)
{
  ...
  // Field name: kf_id_for_landmarks
  {
    ...
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->kf_id_for_landmarks, size)) {
      return "failed to create array for field 'kf_id_for_landmarks'";
    }
    auto array_ptr = ros_message->kf_id_for_landmarks.data;
...
{
  return max_serialized_size_slam_msgs__srv__GetMap_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_slam_msgs__srv__GetMap_Response(
    full_bounded, 0);
}
