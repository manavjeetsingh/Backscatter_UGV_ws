...
#include "slam_msgs/msg/detail/slam_info__rosidl_typesupport_fastrtps_c.h"
...
using _SlamInfo__ros_msg_type = slam_msgs__msg__SlamInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: num_keyframes_in_current_map
  {
    cdr << ros_message->num_keyframes_in_current_map;
  }

  // Field name: tracking_frequency
  {
...
size_t get_serialized_size_slam_msgs__msg__SlamInfo(
  const void * untyped_ros_message,
...
static uint32_t _SlamInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_slam_msgs__msg__SlamInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_slam_msgs
size_t max_serialized_size_slam_msgs__msg__SlamInfo(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_slam_msgs__msg__SlamInfo(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, msg, SlamInfo)() {
