...
static const _GetLandmarksInView_Request_type_support_symbol_names_t _GetLandmarksInView_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetLandmarksInView_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetLandmarksInView_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetLandmarksInView_Request)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetLandmarksInView_Request_message_type_support_handle;
}
...
static const _GetLandmarksInView_Response_type_support_symbol_names_t _GetLandmarksInView_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetLandmarksInView_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetLandmarksInView_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_slam_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetLandmarksInView_Response)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetLandmarksInView_Response_message_type_support_handle;
}
...
static const _GetLandmarksInView_type_support_symbol_names_t _GetLandmarksInView_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetLandmarksInView)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetLandmarksInView)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetLandmarksInView)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetLandmarksInView_service_type_support_handle;
}
