...
static const _GetGlobalPointCloud_Request_type_support_symbol_names_t _GetGlobalPointCloud_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetGlobalPointCloud_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetGlobalPointCloud_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetGlobalPointCloud_Request)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetGlobalPointCloud_Request_message_type_support_handle;
}
...
static const _GetGlobalPointCloud_Response_type_support_symbol_names_t _GetGlobalPointCloud_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetGlobalPointCloud_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetGlobalPointCloud_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_slam_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetGlobalPointCloud_Response)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetGlobalPointCloud_Response_message_type_support_handle;
}
...
static const _GetGlobalPointCloud_type_support_symbol_names_t _GetGlobalPointCloud_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetGlobalPointCloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetGlobalPointCloud)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetGlobalPointCloud)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetGlobalPointCloud_service_type_support_handle;
}
