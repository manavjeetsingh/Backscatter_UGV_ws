...
#include "slam_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _GetAllLandmarksInMap_Request_type_support_symbol_names_t _GetAllLandmarksInMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetAllLandmarksInMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetAllLandmarksInMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_slam_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetAllLandmarksInMap_Request)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetAllLandmarksInMap_Request_message_type_support_handle;
}
...
static const _GetAllLandmarksInMap_Response_type_support_symbol_names_t _GetAllLandmarksInMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetAllLandmarksInMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetAllLandmarksInMap_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_slam_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetAllLandmarksInMap_Response)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetAllLandmarksInMap_Response_message_type_support_handle;
}
...
static const _GetAllLandmarksInMap_type_support_symbol_names_t _GetAllLandmarksInMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slam_msgs, srv, GetAllLandmarksInMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slam_msgs, srv, GetAllLandmarksInMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, slam_msgs, srv, GetAllLandmarksInMap)() {
  return &::slam_msgs::srv::rosidl_typesupport_c::GetAllLandmarksInMap_service_type_support_handle;
}
