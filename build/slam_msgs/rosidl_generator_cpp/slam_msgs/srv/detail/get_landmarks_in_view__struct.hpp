...
struct GetLandmarksInView_Response_
{
  ...
  using _map_points_type =
    std::vector<slam_msgs::msg::MapPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<slam_msgs::msg::MapPoint_<ContainerAllocator>>::other>;
  _map_points_type map_points;

  // setters for named parameter idiom
  Type & set__map_points(
    const std::vector<slam_msgs::msg::MapPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<slam_msgs::msg::MapPoint_<ContainerAllocator>>::other> & _arg)
  {
