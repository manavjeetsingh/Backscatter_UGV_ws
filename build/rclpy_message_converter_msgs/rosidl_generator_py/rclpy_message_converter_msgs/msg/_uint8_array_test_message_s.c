...
bool rclpy_message_converter_msgs__msg__uint8_array_test_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rclpy_message_converter_msgs.msg._uint8_array_test_message.Uint8ArrayTestMessage", full_classname_dest, 80) == 0);
  }
  rclpy_message_converter_msgs__msg__Uint8ArrayTestMessage * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Uint8ArrayTestMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rclpy_message_converter_msgs.msg._uint8_array_test_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Uint8ArrayTestMessage");
